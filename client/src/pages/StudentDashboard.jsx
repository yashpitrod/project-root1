...
const StudentDashboard = () => {
  ...
  const doctors = [
    { id: 1, name: 'Dr. Sharma', image: doctorSharma, available: true, gender: 'male' },
    { id: 2, name: 'Dr. Patel', image: doctorPatel, available: true, gender: 'male' },
    { id: 3, name: 'Dr. Gupta', image: doctorGupta, available: false, gender: 'female' },
    { id: 4, name: 'Dr. Singh', image: doctorSingh, available: true, gender: 'male' },
  ];
  ...
  const handleTranslate = () => {
    ...
    if (problem.trim()) {
      setTranslatedText(`[Translated to English]: ${problem}`);
    }
  };
  ...
  const handleSubmit = () => {
    if (selectedDoctor && selectedTimeSlot) {
      ...
      // Simulate doctor approval after 2 seconds
      setTimeout(() => {
